...
public class ReportsController {
    ...
    @FXML private ComboBox<String> filterType;      // Classification filter
    @FXML private ComboBox<String> filterAscOrDesc; // Multi-Field Sorting Options
    ...
    public void initialize() {
        ...
        // ── UPDATED: Explicit sorting criteria combinations ──
        if (filterAscOrDesc != null) {
            ...
            filterAscOrDesc.setValue("Generated Date"); // Default fallback choice
        }
    ...
    // ── UPDATED: Multi-Field Evaluator Sorting Logic ─────────────────────────
    private void applySortingComparator() {
        ...
        switch (criteria) {
            ...
            default:
                sortedData.setComparator((r1, r2) -> {
                    if (r1.getGeneratedDateTime() == null) return 1;  // Push nulls to the bottom
                    if (r2.getGeneratedDateTime() == null) return -1;
                    // Descending Order: r2 compares to r1
